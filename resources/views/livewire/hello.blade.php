...
<div class="flex h-screen bg-[#1A1A1A]" style="background-color: #1A1A1A !important;">
    ...
    <div class="flex-1 p-8">
        <h1 style="font-size: 3rem; font-weight: 900; margin-bottom: 1rem; color: white;">
            {{ $message }}
        </h1>
        <p style="font-size: 1.2rem; color: #9CA3AF;">This is a new page where we can add more content later!</p>
    </div>
</div>
